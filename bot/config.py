...
TRANSLATION_SKIP_LOW_VALUE_MESSAGES = parse_bool_env(
    "TRANSLATION_SKIP_LOW_VALUE_MESSAGES",
    True,
)
TRANSLATION_GEMINI_RATE_LIMIT_COOLDOWN_SECONDS = parse_float_env(
    "TRANSLATION_GEMINI_RATE_LIMIT_COOLDOWN_SECONDS",
    60.0,
)
TRANSLATION_GEMINI_BATCH_ENABLED = parse_bool_env(
    "TRANSLATION_GEMINI_BATCH_ENABLED",
    True,
)
TRANSLATION_GEMINI_BATCH_WINDOW_MS = parse_int_env(
    "TRANSLATION_GEMINI_BATCH_WINDOW_MS",
    750,
)
TRANSLATION_GEMINI_BATCH_MAX_SIZE = parse_int_env(
    "TRANSLATION_GEMINI_BATCH_MAX_SIZE",
    5,
)
